...
export function EditLocationForm() {
    ...
    const validateForm = () => {
        ...
        // if (!image_2_url?.includes('http')) {
        //     arr.push('If submitting second image, it must be a valid URL')
        // }
        // if (image_2_url?.includes('png') || image_2_url?.includes('jpg')) {
        //     arr.push('If submitting second image, format must be .jpg or .png')
        // }
    ...
    if (location) return (
        <div id='location-form-container'>
            ...
            <form id='location-form' onSubmit={onSubmit}>
                ...
                <div id='sub-forms'>
                    ...
                    <div id='details-info' className='fields-box'>
                        ...
                        <div className='edit-time-label'>
                            ...
                            <input className='time-input' placeholder='Check in time' type='time' onChange={e => setCheckin(`${`After ${timeConverter(e.target.value)}`}`)}></input>
                        </div>
                        <div className='edit-time-label'>
                            <div className='side-by-side'>
                            ...
                            <input className='time-input' placeholder='Check out time' type='time' onChange={e => setCheckout(`${`Before ${timeConverter(e.target.value)}`}`)}></input>
                ...
                {/* <div disabled={errorsCamp.length > 0 || errorsDetails > 0 ? false : true}> You have unresolved input errors.</div> */}
